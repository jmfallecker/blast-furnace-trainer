...
public class BlastFurnaceTrainerPlugin extends Plugin
{
	...
	{
		log.info("BlastFurnaceTrainer started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("BlastFurnaceTrainer stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "BlastFurnaceTrainer says " + config.greeting(), null);
		}
	}
